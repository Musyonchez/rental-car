...
async function run() {
  try {
    ...
    // Create an array of country documents to insert
    const countriesData = [
    ...
    const result = await database.collection("countries").insertMany(countriesData);

    // Print result
    console.log(`${result.insertedCount} countries were inserted`);
  } finally {
    await client.close();
  }
}
